    ...
    root: ({props}) => ({
        class: [
...

            {
                ...
                'flex-col justify-center sm:justify-start sm:w-48 h-full': props.orientation !== 'horizontal'
            }
        ]
    }),
    menu: ({props}) => ({
    ...
    content: ({props, context}) => ({
        class: [
            ...
            // Hover States
            {
                ...
                'hover:bg-surface-200 dark:hover:bg-black/40 text-surface-900 dark:text-surface-0/80': context.active
            },
