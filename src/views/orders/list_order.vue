<template>
  ...
  <button type="button" @click="push({ id: fields.length, url: '', name: '' })" class="bg-green-400 p-2 mr-2">
    Add
  </button>
  <button @click="save" class="bg-green-400 p-2 mr-2">Submit</button>
...
onMounted(() => {
  mainStore.setBreadcrumbs([
    {label: 'Pedidos'},
    {label: 'Lista de pedidos', route: 'list_orders'}
  ])
})
